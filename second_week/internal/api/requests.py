...
class Requests:
    ...
    async def create(self, startDate: str, climateTechType: str, climateTechModel: str, problemDescryption: str, requestStatus: str, completionDate: str, repairParts: str, clientID: int, credentials: HTTPAuthorizationCredentials = Depends(HTTPBearer())):
        try:
            ...
            return self.repo.create(startDate, climateTechType, climateTechModel, problemDescryption, requestStatus, completionDate, repairParts, user_id, clientID)
